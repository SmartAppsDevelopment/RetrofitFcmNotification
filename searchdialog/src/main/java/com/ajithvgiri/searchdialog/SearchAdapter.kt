...
class SearchAdapter(var onSearchItemSelected: OnSearchItemSelected, private var list: List<SearchListItem>) : RecyclerView.Adapter<SearchAdapter.SearchAdapterViewHolder>() {
