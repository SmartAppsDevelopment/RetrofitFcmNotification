...
class SearchableDialog {
    ...
    constructor(activity: Activity, searchListItems: List<SearchListItem>, dialogTitle: String) {
        this.searchListItems = searchListItems
        this.activity = activity
        this.dialogTitle = dialogTitle
    }

    constructor(activity: Activity, searchListItems: List<SearchListItem>, dialogTitle: String, style: Int) {
        this.searchListItems = searchListItems
        this.activity = activity
        this.dialogTitle = dialogTitle
        this.style = style
